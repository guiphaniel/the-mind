...
size_t CardProto::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protos.CardProto)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_copy_from_start:protos.CardProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
