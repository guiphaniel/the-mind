...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_room_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::protobuf::Room, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::protobuf::Room, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::protobuf::Room, id_),
  PROTOBUF_FIELD_OFFSET(::protobuf::Room, name_),
  PROTOBUF_FIELD_OFFSET(::protobuf::Room, players_),
  1,
  0,
  ~0u,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, sizeof(::protobuf::Room)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protobuf::_Room_default_instance_),
};

const char descriptor_table_protodef_room_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nroom.proto\022\010protobuf\032\014player.proto\"C\n\004"
  "Room\022\n\n\002id\030\001 \002(\005\022\014\n\004name\030\002 \001(\t\022!\n\007player"
  "s\030\003 \003(\0132\020.protobuf.Player"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_room_2eproto = {
  false, false, 105, descriptor_table_protodef_room_2eproto, "room.proto", 
...
class Room::_Internal {
 public:
  using HasBits = decltype(std::declval<Room>()._has_bits_);
...
Room::Room(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:protobuf.Room)
}
Room::Room(const Room& from)
  ...
  id_ = from.id_;
  // @@protoc_insertion_point(copy_constructor:protobuf.Room)
}
...
Room::~Room() {
  // @@protoc_insertion_point(destructor:protobuf.Room)
...
void Room::Clear() {
// @@protoc_insertion_point(message_clear_start:protobuf.Room)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "protobuf.Room.name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Room::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:protobuf.Room)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protobuf.Room)
  return target;
}

size_t Room::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protobuf.Room)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:protobuf.Room)
...
// @@protoc_insertion_point(class_specific_copy_from_start:protobuf.Room)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::protobuf::Room* Arena::CreateMaybeMessage< ::protobuf::Room >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protobuf::Room >(arena);
}
